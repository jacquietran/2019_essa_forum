# Worked example from my presentation at the 2019 ESSA Forum using
# 'National Health Survey' data from the Australian Bureau of Statistics
...
p <- p + labs(
  title = "~50% of Australians aged 85+ reported 0 min of\nphysical activity in the last week",
